...
TitleBar::TitleBar(QWidget *window) : QWidget(window), window_(window) {
    ...
    connect(minimize_, &QPushButton::clicked,
            [this]() { window_->setWindowState(Qt::WindowMinimized); });
    ...
    connect(maximize_, &QPushButton::clicked,
            [this]() { window_->setWindowState(Qt::WindowMaximized); });
    ...
    connect(restore_, &QPushButton::clicked,
            [this]() { window_->setWindowState(Qt::WindowNoState); });
    ...
    close_->setFlat(true);
    connect(close_, &QPushButton::clicked, [this]() { window_->close(); });
